...
**Links:** [Live demo](https://blazenetic.github.io/complex-noise/) · [History](./history.md) · [Meet the Lab](./meet-the-lab.md) · [Teachings & Learnings](./teachings-and-learnings.md) · [Blame](./blame.md) · [Archaeology](./archaeology.md) · [Screenshots](./screenshots.md) · [Changelog](../CHANGELOG.md) · [All docs](./) · [AGENTS.md](../AGENTS.md) · [Contributing](../CONTRIBUTING.md)
...
get it; pass 0 records which nodes it deferred, and pass 1 iterates that list
