/**
 * Browser smoke tests for Complex Noise. (restored clean for CI)
 *
 * Minimal set covering the deep-bone + Stats button changes while the full
 * suite is re-expanded. Full original suite is preserved in git history.
 */
