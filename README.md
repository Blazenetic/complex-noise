...
- Discreet GitHub source link in the footer
...
2. Change theme by editing the `:root` / `[data-still-theme]` variables.
...
Titanium dark surfaces + deep purple accents (Still Theme). Subtle silver-titanium Still Field. Professional, calm, premium feel for Complex State.
