...
| [STILL_FIELD_PHASE_4_HANDOVER.md](./STILL_FIELD_PHASE_4_HANDOVER.md) | **Active brief.** Post-merge review of the three refactor PRs: what was checked function-by-function, the three self-claims the code was not keeping, the eight things deliberately left alone with reasons, and what a later session should pick up |
